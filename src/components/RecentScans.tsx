...
export default function RecentScans({ scans }: RecentScansProps) {
  ...
  return (
    <div className="w-56 bg-[#0a1a19] border border-[rgba(13,99,97,0.3)] rounded-[14px] p-4">
          ...
          return (
            ...
            >
              <div className="flex-1 min-w-0">
                <p className="text-white text-xs font-medium truncate group-hover:text-collab-green transition-colors">
                  {getDomain(scan.url)}
                </p>

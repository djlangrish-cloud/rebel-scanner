      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-4">
            <button
              onClick={handleCopy}
              className="flex items-center gap-1.5 text-xs text-white/60 hover:text-rebel-red transition-colors border border-white/10 hover:border-rebel-red/30 rounded-full px-3 py-1.5"
            >
